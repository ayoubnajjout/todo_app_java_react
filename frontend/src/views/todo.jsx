    ...
    <div>
      ...
      <div className="flex flex-col items-center justify-center mt-20">
        {todos.length === 0 ? (
          <div>
            {" "}
            <h1 className="mt-20 text-lg">You have no data yet</h1>
          </div>
        ) : (
              ...
              {todos.map((todo) => (
                ...
                >
                  ...
                  <td className="px-6 py-4">
                    <button
                      className="text-indigo-600 hover:text-indigo-700 border border-indigo-600 hover:bg-gray-200 text-sm rounded-lg px-5 py-2.5 text-center me-2 mb-2"
                      onClick={(e) => toggletState(e, todo.id)}
                    >
                      {todo.done.toString()}
                    </button>
                  </td>
